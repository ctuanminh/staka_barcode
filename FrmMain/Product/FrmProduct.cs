...
namespace FrmMain
{
    public partial class FrmProduct : FrmBasePos, IReloadableForm
    {
        ...
        public FrmProduct(FrmMainF mainForm, IKiotVietService kiotVietService, IBranchService branchService,
            ISystemService systemService, IProductService productService)
        ...
        private async Task LoadData(string code, long id)
        {
            try
            {
                ...
                grdControlOrders.DataSource = products;
